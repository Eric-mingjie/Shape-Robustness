...
from models.cifar.edge_generator import *
try:
...
# cls_net.eval()
# if args.eval:
#     checkpoint = torch.load('./checkpoint/cifar10/standard/resnet20/checkpoint.pth.tar')
...
# G.load_state_dict(torch.load('./logs2/gan/tiny_64/adv_gangenerator_param.pkl'))
G.load_state_dict(torch.load('./logs2/gan/128/adv_gangenerator_param.pkl'))
# D.load_state_dict(torch.load('./logs2/gan/128/adv_gandiscriminator_param.pkl'))
# Adam optimizer
