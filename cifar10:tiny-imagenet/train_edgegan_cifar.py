...
def test_gen_adv(net, G, testloader, sigma=2, high_threshold=0.2, low_threshold=0.1):
    ...
    total = 0
    net.eval()
    two_nets = cnnedge.InterpNets_EdgeGAN(edgenet, G, net, '1', '2')
    two_nets.eval()
    attack = LinfPGDAttack(epsilon=16/255, alpha=4/255, k=100)
...
def test_c(net, G, test_data, base_path):
    ...
    # Reference to original data is mutated
        ...
        epoch = 1
        use_cuda = True
        test_acc = test_gen(net, G, test_loader, sigma=args.sigma, high_threshold=args.high_threshold, low_threshold=args.low_threshold)
...
for epoch in range(train_epoch):
    ...
    for x_, y_ in train_loader:
        ...
        x_edge = 0.5 * generated1 + (1 - 0.5) * generated2
    ...
    if prec > best_prec:
        ...
        torch.save(cls_net.state_dict(), root+'/model.pth')
